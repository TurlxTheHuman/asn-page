...
function Main() {
  ...
  return (
    <body>
      <div id='center'>
        <a href='https://turlxthehuman.com'><img src='/assets/img/coolturtle.webp' className='turtle' alt='cool-turtle'/></a>
        <h1>AS49132</h1>
        <p>a personal development network</p>
        <div className='links'>
          <a href='https://www.peeringdb.com/net/34140' aria-label="peeringDB">peeringdb.com</a>
          <a href='https://bgp.he.net/AS49132' aria-label="he.net"> bgp.he.net</a>
          <a href='https://bgp.tools/as/49132' aria-label="bgp.tools"> bgp.tools</a>
        </div>
        <ul id='ixp'>
